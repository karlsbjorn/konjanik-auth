...
class GuildMember(Table, tablename="guild_member", schema=None):
    user_id = BigInt(
        default=0,
        null=False,
        primary_key=True,
...
async def forwards():
    ...
    manager.add_column(
        table_class_name="Character",
        tablename="character",
        column_name="realm_id",
        db_column_name="realm_id",
        column_class_name="BigInt",
        column_class=BigInt,
        params={
            "default": 0,
    ...
    manager.add_column(
        table_class_name="Character",
        tablename="character",
        column_name="guild_member",
        db_column_name="guild_member",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
        params={
            "references": GuildMember,
            "on_delete": OnDelete.cascade,
            "on_update": OnUpdate.cascade,
            "target_column": None,
            "null": True,
    ...
    manager.add_column(
        table_class_name="GuildMember",
        tablename="guild_member",
        column_name="main_character_id",
        db_column_name="main_character_id",
